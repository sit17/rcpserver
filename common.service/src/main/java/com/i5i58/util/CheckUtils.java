...
public class CheckUtils {
	...
	//身份证号码权值
	private static final int[] powValue={
			7,9,10,
			5,8,4,
			2,1,6,
			3,7,9,
	...
	//身份证号校验码
	private static final char[] checkCode={
			'1','0','X','9','8',
			'7','6','5','4','3',
			'2'
	};
	...
	{
		Pattern idPattern = Pattern.compile("\\d{17}[0-9|X]");	
		...
		for(int i=0;i<17;i++)
		{
			_pow += (id.charAt(i)-'0')*powValue[i];
		}	
		if(id.charAt(17)!=checkCode[_pow%11]) return false;
		return true;
	}
...
//	 "^((((1[6-9]|[2-9]\\d)\\d{2})-(0?[13578]|1[02])-(0?[1-9]|[12]\\d|3[01]))|(((1[6-9]|[2-9]\\d)\\d{2})-(0?[13456789]|1[012])-(0?[1-9]|[12]\\d|30))|(((1[6-9]|[2-9]\\d)\\d{2})-0?2-(0?[1-9]|1\\d|2[0-8]))|(((1[6-9]|[2-9]\\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00))-0?2-29-))$";
	// 加了时间验证的YYYY-MM-DD 00:00:00 String regex = "^((((1[6-9]|[2-9]\\d)\\d{2})-(0?[13578]|1[02])-(0?[1-9]|[12]\\d|3[01]))|(((1[6-9]|[2-9]\\d)\\d{2})-(0?[13456789]|1[012])-(0?[1-9]|[12]\\d|30))|(((1[6-9]|[2-9]\\d)\\d{2})-0?2-(0?[1-9]|1\\d|2[0-8]))|(((1[6-9]|[2-9]\\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00))-0?2-29-)) (20|21|22|23|[0-1]?\\d):[0-5]?\\d:[0-5]?\\d$";
	return match(regex, str);
	}
