...
public class ParseXMLUtils {
	...
	public static SortedMap<Object, Object> jdomParseXml(String xml){
		SortedMap<Object,Object> orderResult = new TreeMap<Object,Object>();
		try { 
			StringReader read = new StringReader(xml);
			...
			if(list!=null&&list.size()>0){
				for (org.jdom.Element element : list) {
					...
					orderResult.put(element.getName(), element.getText());
					/*try{
