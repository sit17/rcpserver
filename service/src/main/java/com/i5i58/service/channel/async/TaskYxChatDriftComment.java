...
public class TaskYxChatDriftComment implements Runnable {
	...
	public TaskYxChatDriftComment(String roomId, String accId, String fromName, String faceSmallUrl, int vip,
			long vipDeadLine, int guard, long guardDeadLine, long richScore, long score, int fansClub, String clubName,
			int clubLevel, long fansClubDeadLine, String content, boolean levelUp, boolean superUser, JsonUtils jsonUtils) {
		super();
		jsonUtil = jsonUtils;
		this.roomId = roomId;
		this.accId = accId;
