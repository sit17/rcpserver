...
//	private long amount;
	...
	public TaskDataBaseDriftComment(DataSaveThread<ChannelRecord, Long> dataSaveThread,DataSaveThread<MoneyFlow, Long> moneyFlowSaveThread) {
		super();
//		this.accId = accId;
